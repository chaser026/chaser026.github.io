...
| Plain Text |
|-------------|
| ┌─────────────────────────────────────────────────┐<br>│ 第一步：协作数据标注<br>│ （Collaborative Data Annotation）<br>│<br>│ 大规模指令语料 ──→ 本体提取 ──→ 指令选择<br>│ │ │ │<br>│ │ ▼ ▼<br>│ │ 人工精炼 代表性指令集<br>│ │ │<br>│ │ ▼<br>│ │ 指令进化（增加复杂度）<br>│ │ │<br>│ │ ▼<br>│ └──────────→ 多模型生成响应 ──→ 人工排序<br>│ │<br>│ ┌─────────┴──────┐<br>│ ▼ ▼<br>│ 演示数据 D 偏好数据 P<br>│ （高质量少量） （高质量少量）<br>└─────────────────────────────────────────────────┘<br>│<br>▼<br>┌─────────────────────────────────────────────────┐<br>│ 第二步：自动化数据合成<br>│ （Automated Data Synthesis）<br>│<br>│ ├── 拒绝采样（数学）──→ 大规模 D + P<br>│ ├── 执行反馈（编程）──→ 大规模 D + P<br>│ ├── 数据再利用（写作/角色扮演）──→ 大规模 D<br>│ └── 宪法反馈（安全）──→ 大规模 D + P<br>│<br>│ （自动化大量）<br>└─────────────────────────────────────────┘ |
